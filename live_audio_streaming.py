...
def evaluate_response(scenario, expected_tone, word_limit, emphasis, agent_response, lead_saying):
    ...
    - Final Score (0 to 100): make avarage base on the sentiment, tone ans pacing score and produce the final score
    - Recommended Tier: (Tier 1: Excellent, Tier 2: Good, Tier 3: Needs Improvement, Tier 4: Poor)
    ...
    try:
        ...
        if msg_type == "Begin":
            ...
            if formatted:
                print('\r' + ' ' * 80 + '\r', end='')
                print(transcript)
                print(evaluate_response(agent_response=transcript,emphasis="reassurance", scenario="FSBO-Fee-Objection", expected_tone="empathetic", word_limit=25, lead_saying="Respond to: 'I’m worried about fees."))
            else:
